...
if(isset($_POST))
{
	...
	$BigImageMaxSize 		= 220; //Image Maximum height or width
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		echo '<span><input type=hidden id=pict name=pict value="'.$NewImageName.'"><img src="./uploads/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail"></span>';
